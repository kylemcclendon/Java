...
public final class Kadmin extends JavaPlugin{
	...
	public static final Set<String> quest = new HashSet<String>();
	...
	private final Hyrule hy = new Hyrule(this);
	...
	public void onEnable(){
		quest.add("Cucco");
		quest.add("Cojiro");
		quest.add("Odd Mushroom");
		quest.add("Odd Potion");
		quest.add("Poacher's Saw");
		quest.add("Broken Sword");
		quest.add("Prescription");
		quest.add("Eyeball Frog");
		quest.add("World's Finest Eye Drops");
		quest.add("Biggoron's Sword");
		...
		if(settings.getBoolean("Hyrule")){
			pm.registerEvents(hy, this);
		}
